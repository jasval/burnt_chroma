...
lipo \
 ...
 swift-bridge-cli create-package \
  ...
  --out-dir SwiftBurntChroma-Debug \
  --ios target/aarch64-apple-ios/debug/libburnt_chroma.a \
  --simulator target/universal-ios/debug/libburnt_chroma.a \
  --macos target/universal-macos/debug/libburnt_chroma.a \
